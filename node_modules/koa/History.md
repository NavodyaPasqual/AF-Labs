...
**others**
  ...
  * [[`6b6b0dd`](http://github.com/koajs/koa/commit/6b6b0ddf7aff073e65493c6efaffab8331c0331c)] - docs(api): add server.use chainability note (#1449) (Zac Anger <<zac@zacanger.com>>)
...
**features**
  * [[`422e539`](http://github.com/koajs/koa/commit/422e539e8989e65ba43ecc39ddbaa3c4f755d465)] - feat: support server.proxyIPHeader and server.maxIpsCount to make ctx.ips more security (Yiyu He <<dead_horse@qq.com>>)
...
**others**
  ...
  * [[`a007198`](http://github.com/koajs/koa/commit/a007198fa23c19902b1f3ffb81498629e0e9c875)] - docs: Document ctx.server.emit (#1284) (Douglas Wade <<douglas.b.wade@gmail.com>>)
...
**fixes**
  * [[`4964242`](http://github.com/koajs/koa/commit/49642428342e5f291eb9d690802e83ed830623b5)] - fix: use X-Forwarded-Host first on server.proxy present (#1263) (fengmk2 <<fengmk2@gmail.com>>)
 ...
 * added: `server.handleRequest()` is exposed
 ...
 * breaking: remove unused `server.name` #899
...
==================
  ...
  * deprecate `server.experimental = true`. Koa v2 does not use this signature.
 ...
 * add `server.silent=<Boolean>` to toggle error logging @tejasmanohar #486
 ...
 * experimental es7 async function support via `server.experimental = true`
 ...
 * add context.inspect(), cleanup server.inspect()
 * update cookies
 ...
 * assert when non-error is passed to server.onerror #287
 * bump finished
 ...
 * fix: inspection of `server` and `server.toJSON()`
 ...
 * remove server.jsonSpaces settings - moved to [koa-json](https://github.com/koajs/json)
 ...
 * remove server.keys getter/setter, update cookies, and remove keygrip deps
 * update fresh
 * update koa-compose
 ...
 * add GeneratorFunction assertion for server.use(). Closes #120
 ...
 * remove `next` is `server.callback()`
